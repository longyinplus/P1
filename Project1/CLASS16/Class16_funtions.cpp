...
int yoloV3()
{
	...
	//coco数据集的名称文件，80类
	string classesFile= "D:\\VS-OpenCv\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "D:\\VS-OpenCv\\yolov3.cfg";
	//权重
	String weights = "D:\\VS-OpenCv\\yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "D:\\VS-OpenCv\\openpose_pose_coco.prototxt";
	String modelBin = "D:\\VS-OpenCv\\pose_iter_440000.caffemodel";
